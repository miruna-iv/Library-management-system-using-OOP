...
DELETE FROM angajat_cititor;
DELETE FROM angajat_cititor_carti;
DELETE FROM sqlite_sequence WHERE name IN ('librarii','carti','clienti','angajati','angajat_cititor');
...
INSERT INTO angajati (idLibrarie, nume, varsta, gen, salariu, anAngajare, departament) VALUES
    (1, 'Ion Popescu', 35, 'M', 3000.00, 2015, 0),
    (1, 'Maria Ionescu', 28, 'F', 2800.00, 2018, 1),
    (2, 'Radu Georgescu', 40, 'M', 3500.00, 2010, 2),
    (2, 'Ioana Stanescu', 32, 'F', 3100.00, 2014, 3),
    (3, 'Bogdan Marin', 45, 'M', 4000.00, 2008, 4),
    (3, 'Cristina Lungu', 29, 'F', 2900.00, 2017, 5),
    (4, 'Florin Badea', 38, 'M', 3300.00, 2012, 0),
    (4, 'Gabriela Stoica', 31, 'F', 3000.00, 2016, 1),
    (5, 'Julien Barbu', 42, 'M', 3600.00, 2009, 2),
    (5, 'Karina Nica', 33, 'F', 3200.00, 2015, 3);

-- ============================================================
--  ANGAJAT_CITITOR
-- ============================================================

INSERT INTO angajat_cititor (idLibrarie, nume, varsta, gen, salariu, anAngajare, departament, buget, nrCartiCumparate, areCardFidelitate) VALUES
    (1, 'Alexandru Duma', 30, 'M', 3200.00, 2016, 2, 150.00, 2, 1),
    (2, 'Mihai Dumitrescu', 36, 'M', 3400.00, 2011, 3, 200.00, 3, 1),
    (3, 'Dan Enache', 27, 'M', 2800.00, 2018, 4, 100.00, 1, 0),
    (4, 'Horia Vasile', 39, 'M', 3500.00, 2010, 5, 180.00, 2, 1),
    (5, 'Lucian Oprea', 34, 'M', 3300.00, 2013, 0, 120.00, 1, 0);

-- ============================================================
--  CARTI CUMPARATE ANGAJAT_CITITOR
-- ============================================================

INSERT INTO angajat_cititor_carti (idAngajatCititor, idCarte) VALUES
    (1, 1), (1, 2),
    (2, 7), (2, 8), (2, 9),
    (3, 12),
    (4, 17), (4, 18),
